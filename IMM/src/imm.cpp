...
void run_with_parameter(InfGraph &g, Argument & arg) //const
{
  ...
  vector<int> k_values{1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000};//, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000};
  vector<double> epsilon_values{0.1};//, 0.01};
