...
class Imm
{
    private:
        ...
        /* Sampling.
        This phase iteratively generates random RR sets and puts them into a
        set R, until a certain stopping condition is met.
        */
        ...
        /*  Node Selection.
        This phase applies the standard greedy algorithm for maximum coverage
        [34] to derive a size-k node set S* that covers a large number of RR 
        sets in R. It then returns S* as the ﬁnal result.
        */
