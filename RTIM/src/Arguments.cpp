...
string Arguments::generateFileName(string type, int param){
  ...
  if (type == "save_infScores"){
    ...
    file_name = datasets[dataset] + "_k" + k + "_r" + properStringDouble(reach) + "_ap" + properStringDouble(theta_ap) + "_" + keyword[streamModel] + "_v" + to_string(streamVersion) + "_s" + to_string(streamSize) + "_ss" + to_string(param) + ".txt";
